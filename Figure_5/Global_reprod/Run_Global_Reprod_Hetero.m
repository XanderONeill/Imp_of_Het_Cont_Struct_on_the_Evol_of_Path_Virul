%%% Running the irregular network evolution model but with global
%%% reproduction

% The same as the standard heterogeneous model, except with the function
% 'Gillespie_Graph' being adjusted to allow for global reproduction instead
% of just local, using the parameter G_R. For our manuscript G_R=1 but it
% is easy enough to modify this in 'Gillespie_Graph'
