...
load('Gt0.mat');    y_means(1)  = mean(mean_alpha_vec);
                    y_sd(1)     = std(mean_alpha_vec);
load('Gt01.mat');   y_means(2)  = mean(mean_alpha_vec);
                    y_sd(2)     = std(mean_alpha_vec);
load('Gt02.mat');   y_means(3)  = mean(mean_alpha_vec);
                    y_sd(3)     = std(mean_alpha_vec);
load('Gt03.mat');   y_means(4)  = mean(mean_alpha_vec);
                    y_sd(4)     = std(mean_alpha_vec);
load('Gt04.mat');   y_means(5)  = mean(mean_alpha_vec);
                    y_sd(5)     = std(mean_alpha_vec);
load('Gt05.mat');   y_means(6)  = mean(mean_alpha_vec);
                    y_sd(6)     = std(mean_alpha_vec);
load('Gt06.mat');   y_means(7)  = mean(mean_alpha_vec);
                    y_sd(7)     = std(mean_alpha_vec);
load('Gt07.mat');   y_means(8)  = mean(mean_alpha_vec);
                    y_sd(8)     = std(mean_alpha_vec);
load('Gt08.mat');   y_means(9)  = mean(mean_alpha_vec);
                    y_sd(9)     = std(mean_alpha_vec);
load('Gt09.mat');   y_means(10) = mean(mean_alpha_vec);
                    y_sd(10)    = std(mean_alpha_vec);
load('Gt1.mat');    y_means(11) = mean(mean_alpha_vec);
